 ...
 * Übersetzungen.
 *
 * Preise aus catalog.json (Admin-Portal). Die Werte sind „ab"-Preise
...
export const SMART_HOME_PACKAGES: SmartHomePackage[] = [
  { id: 'check', price: price('sh.check'), points: 4 },
  { id: 'start', price: price('sh.start'), from: true, featured: true, points: 4 },
  { id: 'betrieb', price: price('sh.betrieb'), from: true, points: 4 },
];
